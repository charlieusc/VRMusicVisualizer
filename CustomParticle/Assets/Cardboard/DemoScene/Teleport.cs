...
public class Teleport : MonoBehaviour, ICardboardGazeResponder {
  private Vector3 startingPosition;
	public static int particleSelected = 1;
	public static bool particleChanged = false;
  ...
  public void OnGazeTrigger() {
	...
	public void setMusicVisualizer1(){
		//gameObject.SendMessage("killParticle");
		particleSelected = 0;
		particleChanged = true;
		Debug.Log ("musicVisualizer1 selected!");
	}
	public void setMusicVisualizer2(){
		//gameObject.SendMessage("killParticle");
		particleSelected = 1;
		particleChanged = true;
		Debug.Log ("musicVisualizer2 selected!");
	}
	public void setStarTravel(){
		//gameObject.SendMessage("killParticle");
		particleSelected = 2;
		particleChanged = true;
		Debug.Log ("starTravel selected!");
	}
	public void setAllParticle(){
		//gameObject.SendMessage("killParticle");
		particleSelected = 3;
		particleChanged = true;
		Debug.Log ("All Particle Effect selected!");
	}
}
